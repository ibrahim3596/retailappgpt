...
fun ProductReviewScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                "Sale price cannot exceed MRP. GTIN-sized numeric barcodes must have a valid check digit.",
                    ...
                    viewModel.saveProduct(
                        ...
                        onResult = { result ->
                            when (result) {
                                ...
                                SaveProductResult.InvalidBarcode -> errorMessage = "This numeric GTIN-shaped barcode has an invalid check digit. Verify the barcode or enter a supported custom barcode format."
